    ...
    def layout_by_resource
      if controller_name == "home" || controller_name == "account" || controller_name == "checkout" || controller_name == "blog" ||
        ...
        "login"
            ...
            controller_name == "delivery_methods" || controller_name == "payment_methods" || controller_name == "comments" || controller_name == "coupons" || controller_name == "vouchers" || controller_name == "comment_articles"
        authenticate_user!
        "backend"
      end
    end
