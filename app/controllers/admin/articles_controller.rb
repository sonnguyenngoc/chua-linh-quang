class Admin::ArticlesController < ApplicationController
  ...
  def index
    ...
    @articles = Article.order("posted_at DESC").search(params).paginate(:page => params[:page], :per_page => 10)
  end
  ...
  private
    ...
    def article_params
      params.require(:article).permit(:image_url, :title, :content, :is_show, :is_mine, :posted_at)
    end
end
