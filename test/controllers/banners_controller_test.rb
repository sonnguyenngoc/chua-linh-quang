...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { banner_type: @banner.banner_type, image_url: @banner.image_url, title: @banner.title }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { banner_type: @banner.banner_type, image_url: @banner.image_url, title: @banner.title }
    assert_redirected_to banner_path(assigns(:banner))
  end
