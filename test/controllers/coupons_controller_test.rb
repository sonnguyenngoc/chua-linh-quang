...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { code: @coupon.code, description: @coupon.description, from_date: @coupon.from_date, name: @coupon.name, quantity: @coupon.quantity, to_date: @coupon.to_date }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { code: @coupon.code, description: @coupon.description, from_date: @coupon.from_date, name: @coupon.name, quantity: @coupon.quantity, to_date: @coupon.to_date }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
