...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { home_meta_description: @option.home_meta_description, home_meta_keywords: @option.home_meta_keywords, home_title: @option.home_title }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { home_meta_description: @option.home_meta_description, home_meta_keywords: @option.home_meta_keywords, home_title: @option.home_title }
    assert_redirected_to option_path(assigns(:option))
  end
