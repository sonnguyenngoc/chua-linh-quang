...
class CommentArticlesControllerTest < ActionController::TestCase
  ...
  test "should create comment_article" do
    assert_difference('CommentArticle.count') do
      post :create, comment_article: { article_id: @comment_article.article_id, content: @comment_article.content, email: @comment_article.email, name: @comment_article.name, user_id: @comment_article.user_id }
    end
  ...
  test "should update comment_article" do
    patch :update, id: @comment_article, comment_article: { article_id: @comment_article.article_id, content: @comment_article.content, email: @comment_article.email, name: @comment_article.name, user_id: @comment_article.user_id }
    assert_redirected_to comment_article_path(assigns(:comment_article))
  end
